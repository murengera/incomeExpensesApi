...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if not username.isalnum():
            raise  serializers.ValidationError('the username shoul only contain alphanumeric character')
        return  attrs
...
class LoginSerializer(serializers.ModelSerializer):
    ...
    tokens = serializers.CharField(max_length=55,read_only=True)
    class Meta:
        model=User
...
class serNewPasswordSerializer(serializers.Serializer):
